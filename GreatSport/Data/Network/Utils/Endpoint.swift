...
public protocol Requestable {
    ...
    func urlRequest(with networkConfig: ApiDataNetworkConfig) throws -> (URLRequest , [String: Any])
}
...
//        }
    ...
    public func urlRequest(with config: ApiDataNetworkConfig) throws -> (URLRequest , [String : Any]) {
